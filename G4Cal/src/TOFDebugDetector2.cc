...
{
	// ce détecteur est constitué de deux blocs du ScanGE, à 20 cm l'un de l'autre, symétriquement par rapport au centre
	// sur l'axe x, remis (plus ou moins) à l'endroit.
	//j'ai gardé la numérotation pour pouvoir se référer à ScanGE, mais la structure n'a que deux niveaux.
